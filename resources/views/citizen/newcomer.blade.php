            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form id="newcomer" name="newcomer" action="{{ route('citizen.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                      <label for="inputFullName" class="col-sm-2 col-form-label">Fullname</label>
                      <div class="col-sm-10">
                        <div class="form-floating">
                          <input type="text" class="@error('fullname') is-invalid @enderror form-control" id="fullname" placeholder="Your Name" name="fullname" :value="{{ old('fullname') }}" autofocus required>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <div class="form-floating">
                          ...
                          oninput="this.value = this.value.replace(/[^0-9]/g, '');" :value="{{ old('phone') }}" required>
                    ...
                    <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input class="@error('marital') is-invalid @enderror form-check-input" type="radio" name="marital" id="marital-married" value="Married" checked>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="form-floating mb-3">
                            <select class="@error('res_stats') is-invalid @enderror form-select" form="newcomer" id="res_stats" aria-label="State" name="res_stats" :value="{{ old('res_stats') }}" required>
                                <option selected disabled>Choose Category</option>
                                <option value="Permanent" {{ old('res_stats') == 'Permanent' ? 'selected' : '' }}>Permanent</option>
                                <option value="Contract" {{ old('res_stats') == 'Contract' ? 'selected' : '' }}>Contract</option>
                            </select>
